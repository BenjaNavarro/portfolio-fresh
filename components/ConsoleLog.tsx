export default function ConsoleLog() {
  return (
    <p class={`text-xl md:text-2xl flex bg-[#eeeeee] dark:bg-[#111111] select-none`}>
        <code>console<span>.<span>log</span></span>("</code>
        <div class="flex flex-col text-center animate-move-sm md:animate-move text-sm sm:text-base md:pt-2">
